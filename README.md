...
2. **Interface Holográfica**: Para uma experiência de programa nativo no Windows, pressione **F11** no seu navegador para entrar em modo Tela Cheia. Isso elimina as barras e transforma o monitor no HUD tático do Megatron.
3. **Link Neural**: O sistema requer acesso ao microfone para ouvir as ordens de seu mestre.
4. **Cérebro SSD**: Todos os ensinamentos são gravados fisicamente no seu armazenamento como matrizes de dados permanentes no disco A:.
